...
#DATA_DIR="/data/tungtv/Code/dataset/dataset_cafebiz_full_45" && \
DATA_DIR="/home/ngoc/Downloads/WORK_ADTECH/chameleon/Ngoc_test/dataset_cafebit_78_mini" && \

#Testing pre-processing with new contextual features
python3 -m nar.preprocessing.nar_preprocess_cafebiz_full \
	...
	--input_nar_encoders_dict_path ${DATA_DIR}/pickles/nar_encoders_cafebiz.pickle \
	--number_hours_to_preprocess 1463 \
 	--output_nar_preprocessing_resources_path ${DATA_DIR}/pickles/nar_preprocessing_resources.pickle \
 	--output_sessions_tfrecords_path "${DATA_DIR}/sessions_tfrecords_by_hour/cafebiz_sessions_hour_*.tfrecord.gz"
