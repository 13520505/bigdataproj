...
MODEL_DIR='/data/tungtv/Code/dataset/dataset_cafebiz_full_45/tmp/chameleon/jobs/tungtv_cafebiz_2019_07_19_191839' && \
...
python3 -m nar.nar_trainer_cafebiz_full \
	...
	--train_files_from 1454 \
	--train_files_up_to 1455 \
