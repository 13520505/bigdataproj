...
def tokenize_norwegian_article(text):
    words_tokenized = []
    for sentence in nltk.tokenize.sent_tokenize(text, language='vietnamese'):
        words_tokenized.extend(nltk.tokenize.word_tokenize(sentence, language='vietnamese'))
...
def main():
    ...
    tokenized_articles = tokenize_articles(news_df['text_highlights'].values, tokenization_fn=tokenize_vietnamese_article)
